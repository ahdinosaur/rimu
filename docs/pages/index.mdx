...
The "programmatic user data" case is the motivating use case for the author ([Mikey](https://mikey.nz) at [Village Kit](https://villagekit.com)), so this may inform future developments. If Rimu is not suitable, see [related projects](./related)
