...
pub(crate) fn tokenize_block(
    ...
    for lines_token in lines_tokens {
        ...
        match lines_token {
            ...
            LinesToken::Dash => tokens.push(Spanned::new(Token::Dash, span)),
...
",
        ...
        let expected = Ok(vec![
            ...
            Spanned::new(Token::Dash, span(13..14)),
            Spanned::new(Token::Indent, span(13..15)),
            Spanned::new(Token::Identifier("c".into()), span(15..16)),
            Spanned::new(Token::EndOfLine, span(16..17)),
            Spanned::new(Token::Dedent, span(21..21)),
            Spanned::new(Token::Dash, span(21..22)),
            Spanned::new(Token::Indent, span(21..23)),
            Spanned::new(Token::Identifier("d".into()), span(23..24)),
            Spanned::new(Token::EndOfLine, span(24..25)),
            Spanned::new(Token::Dedent, span(29..29)),
            Spanned::new(Token::Dash, span(29..30)),
            Spanned::new(Token::Indent, span(29..31)),
